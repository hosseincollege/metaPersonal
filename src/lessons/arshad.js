...
export default [
  ...
  ============================================================ */
  {
    section: " ۱: معماری و اصول بنیادین اینترنت",
    topics: [
      {
        title: "1- سوئیچینگ",
        content: "",
  ...
  ============================================================ */
  {
    section: " ۲: لایه فیزیکی و لایه پیوند داده",
    topics: [
      {
  ...
  ============================================================ */
  {
    section: " ۳: لایه شبکه (Network Layer)",
    topics: [
      {
        title: "1- پروتکل IP",
        content: "",
  ...
  ============================================================ */
  {
    section: " ۴: لایه انتقال (Transport Layer)",
    topics: [
      {
        title: "1- TCP vs UDP",
        content: "",
